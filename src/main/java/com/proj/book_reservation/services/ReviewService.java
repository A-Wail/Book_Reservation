...
public class ReviewService {
    ...
    public ResponseEntity<?> inputReview(Long bookId, Long userId, InputReviewDTO review){
    ...
    public ResponseEntity<?> updateReview(Long reviewId,Long userId, InputReviewDTO review) {
